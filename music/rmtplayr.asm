...
;* (c) Radek Sterba, Raster/C.P.U., 202009
...
;*	  a) from PLAYER-$to PLAYER for stereo RMTplayer
;*    b) from PLAYER-$to PLAYER for mono RMTplayer
;*
...
;*
;* STEREOMODE	equ 0..3			;compile RMTplayer for 4 tracks mono
