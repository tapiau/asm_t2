;* --------BEGIN--------
;* C:\Users\Bart\Google Drive\Magic Briefcase\rmt128\songs\wieczor\random2k18\random_s.rmt
FEAT_SFX		equ 0
...
FEAT_FILTER		equ 1		;(1 times)
FEAT_FILTERG0L		equ 0		;(0 times)
FEAT_FILTERG1L		equ 1		;(1 times)
