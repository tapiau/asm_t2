...
screen_fill_raster:
	REG_PUSH
	mwa screen_adr screen_fill_raster_loop_2+1
	lda #$AA
	ldx #24
screen_fill_raster_loop_1
	ldy #0	
screen_fill_raster_loop_2	
	sta $0000,y
	iny
	bne screen_fill_raster_loop_2
	inc screen_fill_raster_loop_2+2
	dex
	bne screen_fill_raster_loop_2
	REG_PULL
	rts	
